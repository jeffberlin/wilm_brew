...
function AppViewModel() {
  ...
  self.shops = ko.observableArray([{
	...
	},
	{
	  ...
	  locations: [{
		...
		foursquareId: '592dd545cad1b657307a673a'
	  }],
	  showListing: ko.observable(true)
	},
	{
	  title: "Waterman's Brewing",
	  locations: [{
		location: {
		  lat: 34.220880,
		  lng: -77.820232
  ...
  function initMap() {
	...
	this.populateInfoWindow = function(marker, infowindow) {
	  ...
	  //var foursquareUrl = 'https://api.foursquare.com/v2/venues/' + marker.id;
		...
		$.ajax({
		  ...
		  success: function(data) {
			...
			var venueURL = data.response.venue.url ? data.response.venue.url : " ";
